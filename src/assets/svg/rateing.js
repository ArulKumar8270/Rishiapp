...
function RateingIcon({color,width,height}) {
  return (
...
const Rate = ({color,width,height}) => (
    ...
    height={height || 100}
      ...
      {...props}
    >
      <path d="M512 736.853 775.68 896l-69.973-299.947 232.96-201.813-306.774-26.453L512 85.333 392.107 367.787 85.333 394.24l232.534 201.813L248.32 896 512 736.853Z" />
    </svg>
  )
 
export {RateingIcon,Rate}
